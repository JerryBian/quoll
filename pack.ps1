...
dotnet pack src/console/Console.csproj -c Release --include-source --include-symbols --output $OutputPath -p:PackageVersion=$Version

$PkgPath="$OutputPath/quoll.$Version.nupkg"
